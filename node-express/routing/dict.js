...
router.get("/countroots1/", (req, res) => {
...
router.put("/updateallrootnumbers/", (req, res) => {
    var rootIds = [];
...
router.get("/putfamiliesverbs/", (req, res) => {
    var rootIdOld = "";
    var rootIdNew = "";
    var familiesverbs = [];
    function one() {
                ...
                dbo.collection("translations").find(query).toArray(function (err, results) {
                    ...
                    results.map((result, key) => {
                        ...
                        translations.push({
                            ...
                            sentence1SoundFileExist: "0",
                            sentence2SoundFileExist: "0",
                            sentence3SoundFileExist: "0",
